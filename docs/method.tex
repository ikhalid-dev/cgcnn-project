...
enough to reproduce the table above independently, and enough for a future
adapter script to run ALIGNN's own moduli through
Section~7's \texttt{slack\_physics()} the way the CGCNN ensemble's are, which
this document does not yet do.
