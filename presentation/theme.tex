...
\usepackage{fontspec}
% Ligatures=TeX is what turns "---" into an em dash and `` '' into quotes.
% Without it fontspec passes them through literally, and 15 slide titles were
% printing three hyphens.
\setmainfont{Avenir Next}[Ligatures=TeX]
\setsansfont{Avenir Next}[Ligatures=TeX]
\newfontfamily\headingfont{Georgia}[Ligatures=TeX]
